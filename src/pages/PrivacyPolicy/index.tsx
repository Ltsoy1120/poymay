      ...
      <div className="privacy-policy">
        ...
        <section>
          ...
          <p>
            ...
            соответствии с требованиями закона РК «О персональных данных и их
            защите» и определяет порядок обработки персональных данных и меры по
            обеспечению безопасности персональных данных Товариществом с
            ограниченной ответственностью «ПУТЁВКА КЗ» и РГУ «Коргалжынский
            государственный природный заповедник» КЛХЖМ МЭГПР РК (далее –
            Оператор) в электронной системе Poymay.kz. Оператор ставит своей
            ...
            частной жизни, личную и семейную тайну. Настоящая политика Оператора
            ...
            <a href="https://web.poymay.kz">https://web.poymay.kz</a> и
            связанных с ним мобильных приложений.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            информационных материалов, а также программ для ЭВМ, мобильных
            приложений и баз данных, обеспечивающих их доступность в сети
          ...
          <p>
            ...
            веб-сайта <a href="https://web.poymay.kz">https://web.poymay.kz</a>{" "}
            ;
          </p>
          <p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Данные геолокации Пользователя и места осуществления
              фотографирования, сьемки видеозаписи с использованием электронной
              системы Оператора.
            </li>
          </ul>
          <p>
        ...
        <section>
          ...
          <p>
            <strong>
              - идентификация Пользователя и его места нахождения (геолокация)
              при отправке им сообщений в электронной системе Оператора о
              выявления фактов браконьерства и использовании незаконного орудия
              лова или охоты, с целью исключения отправки Пользователем
              указанных ложных сообщений и/или идентификации сообщения как
              ложного;
            </strong>
          </p>
          <p>
            <strong>
              - предоставление возможности Пользователю в режиме on-line
              определять место нахождения Пользователя и маршрута до места
              рыбалки/охоты, егерских пунктов и других точек на электронной
              карте в электронной системе Оператора.
            </strong>
          </p>
          <p>
            ...
            электронной почты info@poymay.kz с пометкой «Отказ от уведомлениях о
            новых продуктах и услугах и специальных предложениях».
          </p>
          <p>
            Обезличенные данные Пользователей, собираемые с помощью сервисов
            интернетстатистики, служат для сбора информации о действиях
        ...
        <section>
          ...
          <p>
            ...
            через специальныеформы, расположенные на сайте{" "}
            <a href="https://web.poymay.kz">https://web.poymay.kz</a> и
            связанных с ним мобильных приложений. Заполняя соответствующие формы
        ...
        <section>
          ...
          <p>
            ...
            неуполномоченных лиц. Персональные данные Пользователя никогда, ни
          ...
          <p>
            ...
            может актуализировать их самостоятельно, либо путем направления
            Оператору уведомление на адрес электронной почты Оператора
            info@poymay.kz с пометкой «Актуализация персональных данных».
          </p>
          <p>
            ...
            info@poymay.kz с пометкой «Отзыв согласия на обработку персональных
            данных».
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            к Оператору с помощью электронной почты info@poymay.kz. В данном
            ...
            замены ее новой версией. Актуальная версия Политики в свободном
            доступе расположена в сети Интернет по адресу{" "}
            <a href="https://web.poymay.kz">https://web.poymay.kz</a>
          </p>
        </section>
      </div>
      <Footer />
